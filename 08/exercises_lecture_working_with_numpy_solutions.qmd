...
# Compute tests
SE = np.sqrt(var1/n + var2/n)
z  = (mean1 - mean2) / SE

print(f"z-score: {z}")
if abs(z) > 1.96:
    print("Reject null hypothesis: samples come from different distributions.")
else:
    print("Fail to reject null hypothesis: samples may come from the same distribution.")
