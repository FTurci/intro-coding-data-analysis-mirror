...
```{pyodide}
#| caption: "▶ Ctrl/Cmd+Enter | ⇥ Ctrl/Cmd+] | ⇤ Ctrl/Cmd+["
from src.robot_maze_quarto import RobotMaze
```
...
```{pyodide}
#| caption: "▶ Ctrl/Cmd+Enter | ⇥ Ctrl/Cmd+] | ⇤ Ctrl/Cmd+["
robot.delay = 1 # The robot will now take 1 second to perform each action (try changing this to 0.1!)
...
# Render (note: this may take some time to run)
robot.render()
```
